...
def test_example13():
    parser = Parser(file="../../examples/example13.prog")
    ast = parser.parse()
    draw_tree(ast, get_filepath("../../examples/proglan-ast13.png"))

def test_example15():
    parser = Parser(file="../../examples/example15.prog")
    ast = parser.parse()
    draw_tree(ast, get_filepath("../../examples/proglan-ast15.png"))

def test_example16():
    parser = Parser(file="../../examples/example16.prog")
    ast = parser.parse()
    draw_tree(ast, get_filepath("../../examples/proglan-ast16.png"))

def test_example20():
    parser = Parser(file="../../examples/example20.prog")
    ast = parser.parse()
    draw_tree(ast, get_filepath("../../examples/proglan-ast20.png"))

def test_example21():
    parser = Parser(file="../../examples/example21.prog")
    ast = parser.parse()
    draw_tree(ast, get_filepath("../../examples/proglan-ast21.png"))
