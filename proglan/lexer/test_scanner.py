...
def test_example1():
    expected = [
                    ...
                    Lexeme(Lexeme.DEF, line=1, col=4),
                    Lexeme(Lexeme.OPAREN, line=1, col=7),
                    Lexeme(Lexeme.IDENTIFIER, value="x", line=1, col=8),
                    Lexeme(Lexeme.CPAREN, line=1, col=9),
                    Lexeme(Lexeme.OBRACE, line=1, col=11),
                    Lexeme(Lexeme.IDENTIFIER, value="x", line=1, col=13),
                    Lexeme(Lexeme.TIMES, line=1, col=14),
                    Lexeme(Lexeme.IDENTIFIER, value="n", line=1, col=15),
                    Lexeme(Lexeme.CBRACE, line=1, col=17),
